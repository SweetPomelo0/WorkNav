export default function Home() {
  const categories = [
    ...
    },
    {
      title: "AI工具",
      links: [
        { name: "ChatGPT", url: "https://chatgpt.com/", desc: "ChatGPT", icon: "https://cdn.oaistatic.com/assets/favicon-180x180-od45eci6.webp" },
        { name: "Gemini", url: "https://gemini.google.com/app", desc: "Gemini", icon: "https://www.gstatic.com/lamda/images/gemini_sparkle_4g_512_lt_f94943af3be039176192d.png" },
        { name: "Claude", url: "https://claude.ai/", desc: "Claude", icon: "https://claude.ai/favicon.ico" },
        { name: "Kimi", url: "https://www.kimi.com/", desc: "Kimi", icon: "https://www.kimi.com/favicon.ico" }
