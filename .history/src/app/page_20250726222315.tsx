      ...
      <div className="sticky top-0 z-10 mt-3" style={{ background: 'rgba(var(--background-rgb), 0.9)', backdropFilter: 'blur(10px)' }}>
        <div className="max-w-7xl mx-auto px-6 py-3 overflow-x-auto">
          <div className="flex items-center justify-between w-full">
            ...
            {/* 搜索框 - 桌面端 */}
            <div className="relative flex-shrink-0 hidden md:flex items-center ml-4">
              <div className="relative group">
                ...
                <input 
                  type="search" 
                  className="block w-full p-2 pl-10 pr-4 text-sm rounded-lg focus:outline-none transition-all duration-300"
                  placeholder="搜索..."
                  style={{ 
