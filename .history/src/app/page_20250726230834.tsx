  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      <div className="sticky top-0 z-10 mt-3 category-nav-container" style={{ background: 'rgba(var(--background-rgb), 0.9)', backdropFilter: 'blur(10px)' }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 overflow-x-auto">
          <div className="flex items-center">
            <div className="flex-shrink-0 mr-2 md:mr-4">
              <div className="flex items-center">
                ...
                <span className="hidden sm:inline text-base font-medium" style={{ color: 'var(--text-primary)' }}>分类</span>
              </div>
            </div>
            <div className="flex space-x-2 md:space-x-3 overflow-x-auto pb-1 category-scrollbar flex-grow">
              <a 
                href="#"
                onClick={(e) => {
                  e.preventDefault();
                ...
                className="text-sm font-medium whitespace-nowrap px-3 md:px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-md hover:bg-opacity-90 flex-shrink-0"
                style={{ 
            ...
            {/* Search Box */}
            <div className="flex-shrink-0 ml-3 md:ml-6">
              {/* 桌面端搜索框 */}
              <div className="hidden md:block relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 text-base rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                  style={{
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-36 sm:w-48 pl-10 pr-4 text-base rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                        style={{
                          background: 'var(--card-bg)',
                          borderColor: 'var(--card-border)',
                          color: 'var(--text-primary)',
