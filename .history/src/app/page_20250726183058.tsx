  ...
  const categories = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "即梦Jimeng", url: "https://jimeng.jianying.com/ai-tool/home", desc: "AI图片/视频生成", icon: "/img/jimeng.png" }
    ...
    },
    {
      title: "Coze",
      links: [
        { name: "命名专家", url: "https://www.coze.com/store/agent/7530562770308956161?bot_id=true", desc: "Naming Assistant命名专家", icon: "" },
        { name: "中译英", url: "https://www.coze.com/store/agent/7530572378075152440?bot_id=true", desc: "中译英翻译专家", icon: "" },
        { name: "英中译", url: "https://www.coze.com/store/agent/7530572202144694273?bot_id=true", desc: "英中译翻译专家", icon: "" }
      ]
    },
    {
      title: "扣子",
