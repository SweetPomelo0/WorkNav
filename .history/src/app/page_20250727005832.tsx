  ...
  const categories = [
    {
      ...
      links: [
        ...
        { name: "产品规格书", url: "https://doc.weixin.qq.com/sheet/e3_AIoAXwbcAOcMw4Gp1xqSBKFUGK4yP?scode=AH4A8gcSAA4RLIOq0O", desc: "企业微信文档", icon: "https://work.weixin.qq.com/favicon.ico" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Novastar", url: "https://novastar-led.cn/index/products/index/id/124.html", desc: "Novastar诺瓦", icon: "/img/novastar.png" }
