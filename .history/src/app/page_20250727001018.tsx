    ...
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-50">
        ...
        <button
          ...
          className="w-12 h-12 rounded-full border transition-all duration-200 hover:scale-110 hover:shadow-lg flex items-center justify-center relative group"
          style={{
            background: 'var(--card-bg)',
            borderColor: 'var(--card-border)',
            color: 'var(--text-primary)'
          }}
          title={isDarkMode ? '点击切换到亮色模式 | 右键点击跟随系统' : '点击切换到暗黑模式 | 右键点击跟随系统'}
        >
          {/* 提示文本 */}
          <div className="absolute bottom-full mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap bg-black bg-opacity-75 text-white text-xs rounded px-2 py-1 right-0">
            点击: 切换主题<br/>
            右键: 跟随系统
          </div>
          {isDarkMode ? (
