            ...
            <div className="flex-shrink-0 ml-2 md:ml-4">
              ...
              <div className="hidden md:block relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 text-sm rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                  style={{
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-36 sm:w-48 pl-10 pr-4 text-sm rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                        style={{
                          background: 'var(--card-bg)',
                          borderColor: 'var(--card-border)',
                          color: 'var(--text-primary)',
