            ...
            <div className="ml-4 relative flex-shrink-0 hidden md:block">
              <div className="relative" style={{ minWidth: '220px' }}>
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm rounded-lg transition-all duration-300 focus:ring-2 focus:outline-none w-64 lg:w-72"
                  style={{
                    background: 'var(--card-bg)',
                    border: '1px solid var(--card-border)',
                    color: 'var(--text-primary)',
                    boxShadow: isSearching ? '0 4px 12px rgba(0,0,0,0.1)' : 'none'
                  }}
                  onFocus={() => setIsSearching(true)}
                  onBlur={() => setTimeout(() => setIsSearching(false), 200)}
                />
