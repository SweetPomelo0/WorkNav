        ...
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="text-center flex items-center justify-center gap-3">
            ...
            <div className="ml-2 inline-flex items-center">
              <span className="text-xs text-blue-500 dark:text-blue-400 before:content-['•'] before:mr-1 before:text-blue-300 dark:before:text-blue-600 after:content-['•'] after:ml-1 after:text-blue-300 dark:after:text-blue-600">工作网址导航</span>
            </div>
          </div>
        </div>
      </header>
