      ...
      <div className="sticky top-0 z-10 mt-3 category-nav-container" style={{ background: 'rgba(var(--background-rgb), 0.9)', backdropFilter: 'blur(10px)' }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 overflow-x-auto">
          <div className="flex items-center justify-center min-h-[40px]">
            ...
            <div className="flex items-center space-x-1 md:space-x-2 overflow-x-auto pb-1 category-scrollbar flex-grow justify-center">
              <a 
                href="#"
                onClick={(e) => {
                  e.preventDefault();
            ...
            {/* Search Box */}
            <div className="flex-shrink-0 ml-2 md:ml-4 flex items-center justify-center h-full">
              {/* 桌面端搜索框 */}
