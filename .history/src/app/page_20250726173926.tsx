  ...
  const categories = [
    {
      title: "搜索引擎",
      links: [
        { name: "澜精灵", url: "https://www.lanerp.com/Admin/index/index.html", desc: "日志 审批", icon: "/img/lanjingling.png" },
        { name: "飞书", url: "https://enlightv.feishu.cn/wiki/D6Z1wOai9iVI4bkVlumcJprDn2e?fromScene=spaceOverview", desc: "PRD 文档", icon: "https://feishu.cn/favicon.ico" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "百度", url: "https://www.baidu.com", desc: "中文搜索引擎", icon: "" },
        { name: "必应", url: "https://www.bing.com", desc: "微软搜索引擎", icon: "" },
        { name: "DuckDuckGo", url: "https://duckduckgo.com", desc: "隐私保护搜索", icon: "" }
      ]
    },
