...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      {/* Category Navigation */}
      <div className="fixed top-0 left-0 right-0 z-10 mt-3 category-nav-container" style={{ background: 'rgba(var(--background-rgb), 0.9)', backdropFilter: 'blur(10px)' }}>
      ...
      {/* Main Content */}
       <main className="max-w-7xl mx-auto px-6 py-8" style={{ marginTop: '80px' }}>
