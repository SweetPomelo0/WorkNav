export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      {/* Category Navigation */}
      <div className="sticky top-0 z-10" style={{ background: 'var(--header-bg)', borderBottom: '1px solid var(--card-border)', backdropFilter: 'blur(12px)' }}>
            ...
            <div className="flex space-x-2 overflow-x-auto pb-1 scrollbar-thin">
              {categories.map((category, index) => (
                <a 
                  key={index} 
                  href={`#category-${index}`}
                  className="text-xs font-medium whitespace-nowrap px-3 py-1.5 rounded-md transition-all duration-200 hover:scale-105 flex-shrink-0"
                  style={{ 
