...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      {/* Category Navigation */}
      <div className="sticky top-0 z-10 category-nav-container" style={{ background: 'rgba(var(--background-rgb), 0.9)', backdropFilter: 'blur(10px)', borderBottom: '1px solid var(--card-border)' }}>
