  ...
  const categories = [
    {
      ...
      links: [
        ...
        { name: "工作表", url: "https://doc.weixin.qq.com/sheet/e3_AIoAXwbcAOcMw4Gp1xqSBKFUGK4yP?scode=AH4A8gcSAA4ihw7B5r", desc: "企业微信文档", icon: "https://res.wx.qq.com/a/wx_fed/assets/res/NTI4MWU5.ico" },
      ]
    },
    {
      title: "AI工具",
