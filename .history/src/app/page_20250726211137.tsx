        ...
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="text-center flex items-center justify-center gap-3">
            ...
            <div className="ml-2 inline-flex items-center">
              <span className="text-xs px-1.5 py-0.5 rounded bg-gradient-to-r from-blue-500/10 to-indigo-500/10 dark:from-blue-500/20 dark:to-indigo-500/20 text-blue-700 dark:text-blue-300 ring-1 ring-inset ring-blue-700/10 dark:ring-blue-500/30">工作网址导航</span>
            </div>
          </div>
        </div>
      </header>
