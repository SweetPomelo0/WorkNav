      ...
      <header style={{ background: 'var(--header-bg)', borderBottom: '1px solid var(--card-border)' }}>
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="text-center flex items-center justify-center gap-3">
            ...
            <div className="ml-2 px-2.5 py-1 bg-blue-50/50 dark:bg-blue-900/10 rounded-md border border-blue-100 dark:border-blue-800/30 shadow-sm">
              <span className="text-xs text-blue-600 dark:text-blue-300">工作网址导航</span>
            </div>
          </div>
        </div>
      </header>
