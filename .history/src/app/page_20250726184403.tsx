  ...
  const categories = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Watchout", url: "https://www.dataton.com/", desc: "Dataton watchout", icon: "https://resolume.com/images/favicons/apple-touch-icon.png" },
        { name: "Resolume", url: "https://resolume.com/", desc: "Resolume", icon: "/img/resolume.png" },
