  ...
  const categories = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Christie Digital", url: "https://www.christiedigital.com/products/media-servers-and-players/", desc: "Christie Digital", icon: "https://www.christiedigital.com/favicon.ico" }
