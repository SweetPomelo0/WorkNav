    ...
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      <header style={{ background: 'var(--header-bg)', borderBottom: '1px solid var(--card-border)' }}>
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="text-center inline-flex flex-col items-center justify-center">
            ...
            <div className="-mt-1">
              <span className="text-xs font-medium text-blue-500/70 dark:text-blue-400/70">工作网址导航</span>
            </div>
          </div>
        </div>
      </header>
