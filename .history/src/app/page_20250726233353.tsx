...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)', color: 'var(--text-primary)' }}>
      ...
      {/* Category Navigation */}
      <div className="sticky top-0 z-50 mt-3 category-nav-container" style={{ background: 'rgba(var(--background-rgb), 0.95)', backdropFilter: 'blur(12px)', borderBottom: '1px solid var(--card-border)' }}>
